...
2. Можете ли вы сказать, загрузил ли ваш браузер два изображения последовательно или
   ...
   - Параллельно. Наверное старые браузеры и грузили картинки синхроны, но мой вроде как достаточно свежий.
   - В панели разработчика в браузере - нарисовано что запросы выполнялись асинхронно. 
